...
function windowResized() {
    ...
    const containerWidth = document.getElementById('sketch-container').offsetWidth;
    const containerHeight = document.getElementById('sketch-container').offsetHeight;
  
    // Adjust based on the available width of the container
    const newWidth = Math.min(containerWidth * 0.7, canvasWidth);
    const newHeight = (newWidth / canvasWidth) * canvasHeight; // Maintain aspect ratio
